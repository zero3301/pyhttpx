...
class TlsSession():
    ...
    def _tls_do_handshake(self):
        ...
        ciphersuites, extensions = CipherSuites().dump(),dump_extension(self.host)
        ...
        while True:
            ...
            while recv:
                ...
                if handshake_type == 0x17:
                    ...
                    raise ConnectionError('Encrypted Alert')
    ...
    def get(self,path, host,data=None):
        #Connection: keep-alive
        ...
        while True:
            ...
            recv = cache + recv
            print('cache recv',len(recv),recv.hex())
            cache = b''
